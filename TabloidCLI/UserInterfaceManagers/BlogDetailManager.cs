...
        //    Console.WriteLine($"Which tag would you like to add to {blog.FullName}?");
...
        //{
        //    Blog blog = _blogRepository.Get(_authorId);

        //    Console.WriteLine($"Which tag would you like to remove from {blog.FullName}?");
